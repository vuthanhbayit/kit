...
export const REGEXP_EXTENDED_ASCII = /^[\u0001-\u00FF]*$/

export const REGEXP_LATIN_WORD =
  /[A-Z\u00C0-\u00D6\u00D8-\u00DE]?[a-z\u00DF-\u00F6\u00F8-\u00FF]+|[A-Z\u00C0-\u00D6\u00D8-\u00DE]+(?![a-z\u00DF-\u00F6\u00F8-\u00FF])|\d+/g

export const REGEXP_VN_PHONE =
  /^(0|\+84)(\s|\.)?((3[2-9])|(5[25689])|(7[06-9])|(8[1-9])|(9[0-46-9]))(\d)(\s|\.)?(\d{3})(\s|\.)?(\d{3})$/

export const REGEXP_EMAIL = /[^\t\n\r @]+@[^\t\n\r @]+\.[^\t\n\r @]+/

export const toRegex = (value: string | number | RegExp) => {
  return isRegex(value) ? value : new RegExp(String(value), 'i')
}
